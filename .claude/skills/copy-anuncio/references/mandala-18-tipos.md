...
**Referência de exemplos validados:** consulte `references/exemplos-leads-4-categorias.md` para 12 exemplos reais das 4 categorias de lead (Inadequação, Identificação, Plug & Play, Promessa Boa Demais) em 3 nichos. Usar como referência de nível de especificidade, profundidade e inimigo concreto.
...
Depois que o tipo da Mandala estiver definido e ANTES de gerar a copy, abrir `references/elementos-literarios.md` deste pacote e escolher de **1 a 3 elementos** que mais fizerem sentido com o tipo de anúncio escolhido, com a fase do funil, com o perfil do consumidor e com o tom do produto.
...
## Fluxo completo da skill `copy-anuncio` (8 passos)

```
1. Contexto             → ler o briefing do produto (arquivo de perfil, se existir, ou entrevista direta)
...
4. Elementos literários → INTERNO e silencioso: consultar references/elementos-literarios.md e escolher 1 a 3 elementos que combinem com o tipo da Mandala selecionado. Não mostrar ao usuário.
